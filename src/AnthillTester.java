...
public class AnthillTester 
{
	...
	//int[] antNoParam 	= new int[]{100};
	//int[] prunningParam = new int[]{19, 21, 23, 25, 27, 29, 31};
	int[] prunningParam = new int[]{1, 2, 5, 10, 15, 25, 35};
	///int[] prunningParam = new int[]{};
	//float[] pheromonrExpParam = new float[]{};
	...
	private void oneTest(Anthill anthill, int ants, int prunning, float pheromonExpFactor)
	{
		...
		String results_best = "";
		String iters_best = "";
		int oryginalPrunning = FactorCentre.AntPrunningFactor;
		float oryginalPheromonExp = FactorCentre.pheromoneExpFactor;
		
		try 
		{
			FactorCentre.AntPrunningFactor = prunning;
			FactorCentre.pheromoneExpFactor = pheromonExpFactor;
		...
		{
			FactorCentre.AntPrunningFactor = oryginalPrunning;
			FactorCentre.pheromoneExpFactor = oryginalPheromonExp;
		}
	}
